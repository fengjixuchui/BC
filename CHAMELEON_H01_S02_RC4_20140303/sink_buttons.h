...
#define MFB_PIN_MASK	((uint32)1 << MFB_PIN)

#define VOLUP_PIN_MASK	((uint32)1 << VOLUP_PIN)
#define VOLDN_PIN_MASK	((uint32)1 << VOLDN_PIN)
#define EL_EN_PIN_MASK	((uint32)1 << EL_EN_PIN)
#define PLAY_PIN_MASK	((uint32)1 << PLAY_PIN)
#define FF_PIN_MASK		((uint32)1 << FF_PIN)
#define REW_PIN_MASK	((uint32)1 << REW_PIN)
