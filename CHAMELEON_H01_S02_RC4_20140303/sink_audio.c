...
#include "sink_swat.h"
    ...
    /* Just pass digital mic settings to example plugin */
    #define AUDIO_CONNECT_PARAMS &theSink.conf1->PIOIO.digital
    ...
    #define MAX_NUM_AUDIO_PLUGINS_PER_CODEC (7)
    ...
    TaskData * const gCsrPlugins [] [ MAX_NUM_AUDIO_PLUGINS_PER_CODEC ] = 
        {   /*   0             1                 2                3                    4              5            6 */
    /*CVSD*/    {NODSPCVSD,  CVCHS1MIC      , CVCHS1MICBEX    ,  CVCHS2MIC     ,   CVCHS2MICBEX,  CVCHF1MIC,    CVCHF1MICBEX } ,
    /*MSBC*/    {NULL     ,  CVCHS1MICWBS   , CVCHS1MICWBS    ,  CVCHS2MICWBS  ,   CVCHS2MICWBS,  CVCHF1MICWBS, CVCHF1MICWBS } ,
        };
