...
DESCRIPTION
    This file contains the default configuration parameters for a CSR Stereo Sink
*/
...
{
  	6,
    0x9332, 0x8C01, 0x11E7, 0x21A1, 0x3E40, 0xA41A
};
...
static const uint16 led_states[(sizeof(led_config_type) * NO_LED_STATES)+1] =
{
	...
	0x0A64, 0x6401, 0x0000, 0x1EF1,  /*deviceThreeWayMultiCall*/
...
{   
    ...
    0x0102, 0x0008, 0x4001, /* EventPowerOn                             - B_LONG                - VREG & IP3          */ 
    0x0102, 0x0004, 0x4001, /* EventPowerOn                             - B_LONG                - VREG & IP2          */ 
    
    0xEF03, 0x0008, 0x400E, /* EventPeerSessionInquire                  - B_VERY_LONG           - VREG & IP3          */
    0xF003, 0x0004, 0x400E, /* EventPeerSessionConnDisc                 - B_VERY_LONG           - VREG & IP2          */
    0xF102, 0x000C, 0x3FFE, /* EventPeerSessionEnd                      - B_LONG                - IP2 & IP3           */ 
    0x1C08, 0x0000, 0x4002, /* EventEstablishSLC                        - B_SHORT_SINGLE        - VREG                */
...
{  
    sizeof(event_config_type) * BM_EVENTS_PER_PS_BLOCK,
    0x9308, 0x0000, 0x6008, /* EventAvrcpPlayPause                      - B_SHORT                   - VREG            */ 
    0x9508, 0x0008, 0x2008, /* EventAvrcpSkipForward                    - B_SHORT                   - IP3             */    
    0x9608, 0x0010, 0x2008, /* EventAvrcpSkipBackward                   - B_SHORT                   - IP4             */    
    0x9702, 0x0008, 0x2008, /* EventAvrcpFastForwardPress               - B_LONG                    - IP3             */ 
                            
    0x9809, 0x0008, 0x2008, /* EventAvrcpFastForwardRelease             - B_LONG_RELEASE            - IP3             */
    0x980a, 0x0008, 0x2008, /* EventAvrcpFastForwardRelease             - B_VERY_LONG_RELEASE       - IP3             */
    0x980c, 0x0008, 0x2008, /* EventAvrcpFastForwardRelease             - B_VERY_VERY_LONG_RELEASE  - IP3             */
    0x9902, 0x0010, 0x2008, /* EventAvrcpRewindPress                    - B_LONG                    - IP4             */
                            
    0x9a09, 0x0010, 0x2008, /* EventAvrcpRewindRelease                  - B_LONG_RELEASE            - IP4             */
    0x9a0a, 0x0010, 0x2008, /* EventAvrcpRewindRelease                  - B_VERY_LONG_RELEASE       - IP4             */
    0x9a0c, 0x0010, 0x2008, /* EventAvrcpRewindRelease                  - B_VERY_VERY_LONG_RELEASE  - IP4             */
    0xa704, 0x0008, 0x2000, /* EventAvrcpNextGroup                      - B_DOUBLE                  - IP3             */ 
                            
    0xa804, 0x0010, 0x2000, /* EventAvrcpPreviousGroup                  - B_DOUBLE                  - IP4             */
    0x9402, 0x0000, 0x6000, /* EventAvrcpStop                           - B_LONG                    - VREG            */
    0x0000, 0x0000, 0x0000, /*  */
    0x0000, 0x0000, 0x0000, /*  */
...
static const uint16 tone_events[(sizeof(tone_config_type) * NO_TONE_EVENTS)+1] =
{
    ...
    0xEF0D,  /*EventPeerSessionInquire*/
    0xF00D,  /*EventPeerSessionConnDisc*/
    0xF10E   /*EventPeerSessionEnd*/
};
